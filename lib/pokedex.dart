...
class Pokedex {
  ...
  // Questão 11: retorna certas estatísticas como quantidades, médias e percentuais
  ...
  double mediaDeNivel() {
    if (_pokemons.isEmpty) return 0.0; 
    
    int somaNiveis = 0;
    for (var p in _pokemons) {
      somaNiveis += p.nivel;
    }
    return somaNiveis / _pokemons.length;
  }
  ...
  double percentualCapturados() {
    ...
    return (totalCapturados / _pokemons.length) * 100;
  }
}